...
public class ChallengeRestController {
	...
	ResponseEntity<ChallengeDTO> removeChallenge(@PathVariable String challengeId) {
	...
	ResponseEntity<RecordDTO> cancelChallenge(@PathVariable String challengeId, @RequestBody String reason) {
	...
	ResponseEntity<Object> recordChallenge(@PathVariable String challengeId, @RequestBody RecordDTO recordBody) {
	...
	ResponseEntity<ChallengeDTO> updateChallenge(@PathVariable String challengeId) {
